...
if (isset($_GET['sort'])) {
    ...
    switch ($sort_type) {
        case 'newest':
            $sort_order = ' ORDER BY id_sanpham DESC'; // Sắp xếp theo sản phẩm mới nhất
            break;
        case 'popular':
            $sort_order = 'ORDER BY giasp DESC'; // Sắp xếp theo sản phẩm phổ biến nhất
            break;
       
        default:
            $sort_order = ''; // Mặc định không sắp xếp
            break;
    }
}
// Tính số trang
...
$sql_pro = "SELECT * FROM tbl_sanpham WHERE  giasp >= $minPrice AND giasp <= $maxPrice  $sort_order LIMIT $batDau, $soSanPhamTrenTrang";
                                            ...
                                            <div class="product-short">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a href="index.php?quanly=tongsp&trang=<?php echo $trangHienTai; ?>&sort=newest" class="dropdown-item">Newest</a>
                                                        <a href="index.php?quanly=tongsp&trang=<?php echo $trangHienTai; ?>&sort=popular" class="dropdown-item">Popular</a>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item <?php echo ($trangHienTai <= 1) ? 'disabled' : ''; ?>">
                <a class="page-link" href="index.php?quanly=tongsp&trang=<?php echo ($trangHienTai - 1); ?>" tabindex="-1">Previous</a>
            </li>
            <?php for ($i = 1; $i <= $tongSoTrang; $i++) { ?>
                <li class="page-item <?php echo ($i == $trangHienTai) ? 'active' : ''; ?>"><a class="page-link" href="index.php?quanly=tongsp&trang=<?php echo $i; ?>"><?php echo $i; ?></a></li>
            <?php } ?>
            <li class="page-item <?php echo ($trangHienTai >= $tongSoTrang) ? 'disabled' : ''; ?>">
                <a class="page-link" href="index.php?quanly=tongsp&trang=<?php echo ($trangHienTai + 1); ?>">Next</a>
            </li>
        </ul>
    </nav>
</div>
